...
export const SPEED_START = 12;
export const SPEED_CAP = 22;
export const SPEED_RAMP = 0.04;
export const CHARGE_DIST = 250;
export const CHARGE_SPEED = 50;
export const CHARGE_COOL = 1000;
